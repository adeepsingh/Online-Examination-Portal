...
<html>
<head>
<title>Online Examination - Test List</title>
...
{
	echo "<br><br><h2 class=head1> There is no exam available for this Subject </h2>";
	exit;
}
echo "<h2 class=head1> Select Topic from the list to give the Exam </h2>";
